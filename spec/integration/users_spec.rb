...
RSpec.describe 'Users', type: :system, js: true do
  before(:all) do
    @john = User.create(name: 'John Cena', photo: 'https://source.unsplashr.com/1600x900gdsd', bio: 'Welcome to the new era of the WWE. The champ is here!')
    ...
    @post3 = Post.create(title: 'I will never give up', text: 'I will never give up. I will never surrender.', author: @john)
