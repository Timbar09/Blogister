...
RSpec.describe Comment, type: :model do
  describe "creation" do
    before :each do
      @rock = User.create(name: "The Rock", photo: "https://picsum.photos/rock.jpg", bio: "If you smell what The Rock is cooking")
      @austin = User.create(name: "Stone Cold", photo: "https://picsum.photos/austin.jpg", bio: "I am the rattlesnake")

      @post = Post.create(title: "The People's Champ", text: "If you're not down with The Rock, I got two words for ya: SUCK IT!", author: @rock)

      @austin_comment = Comment.create(text: "Is that so?", author: @austin, post: @post)
      @rock_comment = Comment.create(text: "I am the most electrifying man in sports entertainment!", author: @rock, post: @post)
    end
