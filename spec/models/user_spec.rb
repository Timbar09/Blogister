...
RSpec.describe User, type: :model do
  describe "creation" do
    before :each do
      ...
      @post1 = Post.create(title: "WWE Champion", text: "The champ is hereeee! Welcome to the new Raw. Raw is Cena!", author: @cena)
      @post2 = Post.create(title: "To all challengers", text: "If you want some, come get some!", author: @cena)
      @post3 = Post.create(title: "The new WWE title", text: "The new WWE title is here. It is the best title ever!", author: @cena)
      @post4 = Post.create(title: "To all my fans", text: "I am sorry for not being around for a while. I was busy with my new movie. I will be back soon.", author: @cena)
    end
